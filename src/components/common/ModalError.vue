<template>
    <Modal :fullScreenBackdrop="true" @close="closeModal">
        <template #body>
            <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                <div class="text-center">
                    ...
                    <p v-if="props.isHtml" class="text-sm leading-6 text-gray-500 dark:text-gray-400"
                        v-html="props.message"></p>
                    <p v-else class="text-sm leading-6 text-gray-500 dark:text-gray-400">
                        {{ props.message }}
                    </p>
