      ...
      <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        <div class="text-center">
          ...
          <div class="flex items-center justify-center w-full gap-3 mt-7">
            <button
              @click="handleDelete"
              :disabled="commonStore.deleting"
              type="button"
              class="flex justify-center gap-2 w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-warning-500 shadow-theme-xs hover:bg-warning-600 sm:w-auto"
            >
              <span v-if="commonStore.deleting" class="animate-spin">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
