        ...
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
              <div
                class="flex items-center justify-between w-full cursor-pointer"
                @click="sortBy('report_request_type.name')"
              >
            ...
            <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Download</p>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="request in paginatedData" :key="request.id" class="">
            ...
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                {{ request.report_request_type?.name }}
              </p>
            </td>
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <p class="text-gray-700 text-theme-sm dark:text-gray-400">
            ...
            <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
              <div class="flex items-center w-full gap-2">
                <a
                  ...
                  target="_blank"
                  class="inline-flex items-center gap-1 text-brand-500 hover:text-brand-600 text-sm font-medium"
                >
                  <svg
                    class="fill-current"
                    width="18"
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M10.5 3.5C10.5 2.94772 10.9477 2.5 11.5 2.5H15.5C16.0523 2.5 16.5 2.94772 16.5 3.5V7.5C16.5 8.05228 16.0523 8.5 15.5 8.5H11.5C10.9477 8.5 10.5 8.05228 10.5 7.5V3.5ZM12 4V7H15V4H12ZM4.5 6.5C4.5 5.94772 4.94772 5.5 5.5 5.5H8.5C9.05228 5.5 9.5 5.94772 9.5 6.5V17.5C9.5 18.0523 9.05228 18.5 8.5 18.5H5.5C4.94772 18.5 4.5 18.0523 4.5 17.5V6.5ZM6 7V17H8V7H6ZM11.5 10.5C10.9477 10.5 10.5 10.9477 10.5 11.5V17.5C10.5 18.0523 10.9477 18.5 11.5 18.5H15.5C16.0523 18.5 16.5 18.0523 16.5 17.5V11.5C16.5 10.9477 16.0523 10.5 15.5 10.5H11.5ZM12 12H15V17H12V12Z"
                      fill=""
                    />
                  </svg>
                  {{ request.reports[0].file_name }}
                </a>
...
const completedReports = computed(() => {
  return props.reports.filter(
    (r) => r.report_request_status?.slug === 'completed' && r.reports && r.reports.length > 0,
  )
})
...
const {
  ...
  searchFields: ['id', 'report_request_type.name', 'user.name', 'start_date', 'end_date'],
